...
<div class="body-content">
  <div class="module">
    ...
    <form class="form" action="formprocess.php" method="post" enctype="multipart/form-data" autocomplete="off">
      ...
      <input type="text" placeholder="College" name="address" required>
      <input type="text" placeholder="Year" name="dob" required><br>
